...
The dashboard model probe allows up to 60 seconds by default for slow reasoning
models. Override it with the positive-millisecond `MODEL_TEST_TIMEOUT_MS`
environment variable when a provider needs more time.
